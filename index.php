...
<body class="bg-light">
	<div class="text-center p-5">
		...
		<h4><b>Script last modified:</b> <span style="color:#236c82;font-style:italic"><?php date_default_timezone_set('UTC'); echo date("F d Y H:i:s A", filemtime(__FILE__)); ?> (UTC)</span> <a href="https://bucinxdbytio-4.tioclkp02.repl.co/" rel="nofollow" title="Click ini " target="_blank">HERE!!!!</a></h4>
